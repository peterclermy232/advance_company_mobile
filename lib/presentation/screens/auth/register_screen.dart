...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  @override
  void dispose() {
    for (final c in [_emailCtl, _passCtl, _firstCtl, _lastCtl, _phoneCtl]) c.dispose();
    super.dispose();
  }
          ...
          child: Column(
            ...
            children: [
              if (_success != null)
                ...
                _field(_firstCtl, 'First Name', Icons.person_outlined, TextInputAction.next),
                const SizedBox(height: 14),
                _field(_lastCtl, 'Last Name', Icons.person_outlined, TextInputAction.next),
                const SizedBox(height: 14),
                _field(_emailCtl, 'Email', Icons.email_outlined, TextInputAction.next,
                ...
                const SizedBox(height: 14),
                _field(_phoneCtl, 'Phone (optional)', Icons.phone_outlined, TextInputAction.next, type: TextInputType.phone),
                const SizedBox(height: 14),
                TextFormField(
                  controller: _passCtl, obscureText: _obscure, textInputAction: TextInputAction.done,
  ...
  Widget _field(TextEditingController ctl, String label, IconData icon, TextInputAction action,
      {TextInputType? type, String? Function(String?)? validator}) {
    return TextFormField(
      controller: ctl, keyboardType: type, textInputAction: action,
